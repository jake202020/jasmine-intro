describe('Payments test (with setup and tear-down)', function() {
	...
	it('should add Bill and tip to allPayments on submitPaymentInfo()', function() {
		submitPaymentInfo();
	...
	it('should not add a new payment on submtiPaymentInfo() with empty input', function() {
		billAmtInput.value = '';
		tipAmtInput.value = '';
	...
	it('should update payment in #paymentTable on appendPaymentTable()', function() {
